    ...
    <div className="fancy-feature-twentyOne pb-100 pt-80 lg-pb-50 position-relative">
        ...
        <div className="row">
          <div className="col-lg-6 col-md-7 ms-auto">
            <div className="block-style-five ps-xxl-5">
              ...
              <Link href="#contactForm" className="btn-eight ripple-btn">
              Send Message
              </Link>
            </div>
          </div>
      ...
      <div className="illustration-holder">
        <Image
          ...
          width={516} height={437}
        />
         <Image src="images/shape/shape_37.svg" alt="" class="shapes shape-one" width={40} height={40}/> 
    ...
    <div className="service-details position-relative">
      <div className="container">
        <div className="row d-flex align-items-center">
          <div className="col-lg-6">
            <div className="title-style-three contact-service">
              ...
              <p className="mt-10">
                ...
                bring the spirit of innovation to your technology partners
              </p>
            </div>
            <div className="title-style-three contact-service">
              <h4 className="main-title">
                Let's Plan A New <span>Project</span> Together.
              </h4>
              <p className="mt-10">
                We're passionate about solving business problems and achieving
                your vision. Our team would be happy to work with you to make it a
                reality.
              </p>
          ...
          <div className="col-lg-6">
            <Image src="/images/assets/service.png" alt="service-img" width={558} height={344} />
          </div>
        </div>
      </div>
            ...
            <div className="col-md-4 mb-40 sm-mb-20">
              <div className="address-block-two text-center mb-3">
                ...
                <p>
                  ...
                  <Link
                    href="mailto:contact@preciousinfosystem.com"
				...
				<div class="bg-wrapper">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 text-center text-lg-end" data-aos="fade-left">
							<a href="contact-us.html" class="msg-btn ripple-btn">Send Us Message</a>
						</div>
					</div>
				</div>
			</div>
